              ...
              .filter(
                (op) =>
                  !disabledOptions.includes(
                    op.displayName || `${op.firstName} ${op.lastName}`,
                  ),
              )
              .map((op) => {
                const label =
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex items-center gap-4 justify-between">
                      <Button
                        ...
                        variant={winner === 'player1' ? 'winner' : 'outline'}
                        className="flex-1"
                      >
                        {player1}
                      </Button>
                      <Button
                        ...
                        variant={winner === 'player2' ? 'winner' : 'outline'}
                        className="flex-1"
                      >
                        {player2}
                      </Button>
